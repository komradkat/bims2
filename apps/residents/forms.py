...
class ResidentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "citizenship": forms.TextInput(
                attrs={"class": "input input-bordered w-full", "value": "Filipino"}
            ),
            ...
            # Education & Employment
            "educational_attainment": forms.Select(
                attrs={"class": "select select-bordered w-full"}
            ),
            ...
            "philhealth_no": forms.TextInput(
                attrs={
                    "class": "input input-bordered w-full",
                    "placeholder": "XX-XXXXXXXXX-X",
                }
            ),
            "sss_gsis_no": forms.TextInput(
                attrs={
                    "class": "input input-bordered w-full",
            ...
            "years_of_residency": forms.NumberInput(
                attrs={
                    "class": "input input-bordered w-full",
                    "placeholder": "e.g. 10",
                    "min": "0",
            ...
            "is_household_head": forms.CheckboxInput(
                attrs={
                    "class": "checkbox checkbox-primary",
                    "x-model": "isHouseholdHead",
                }
            ),
            "household_head": forms.Select(
                attrs={
                    "class": "select select-bordered w-full",
                    "x-show": "!isHouseholdHead",
                }
            ),
            "relationship_to_head": forms.TextInput(
                attrs={
                    "class": "input input-bordered w-full",
            ...
            # Sectoral Information
            "is_senior_citizen": forms.CheckboxInput(
            ...
            "is_solo_parent": forms.CheckboxInput(
                attrs={"class": "checkbox checkbox-sm"}
            ),
            ...
            "is_voter": forms.CheckboxInput(
                attrs={"class": "checkbox checkbox-sm", "x-model": "isVoter"}
            ),
            "precinct_number": forms.TextInput(
                attrs={
                    "class": "input input-sm input-bordered w-full",
    ...
    def __init__(self, *args, **kwargs):
        ...
        household_heads = Resident.objects.filter(
            is_household_head=True, is_active=True
...
class HouseholdMemberForm(ResidentForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["purok_link"].widget.attrs.update(
