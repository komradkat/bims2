...
class Command(BaseCommand):
    ...
    def _seed_officials(self):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  → {len(roster)} officials processed.\n")
        )
    ...
    def _seed_residents(self):
        ...
        residents_data = [
            ...
            (
                ...
                "",
                "09361234586",
                {"is_senior_citizen": True, "is_voter": True},
            ),
            (
                "Cristina",
                "Aquino",
            ...
            (
                ...
                "",
                "09411234591",
                {"is_senior_citizen": True, "is_indigent": True},
            ),
        ]
        ...
        for p_name in purok_names:
            p_obj, _ = Purok.objects.get_or_create(
                name=p_name, defaults={"slug": slugify(p_name)}
            )
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  → {len(residents_data)} residents processed.\n")
        )
    ...
    def _seed_business_permits(self):
        ...
        businesses = [
            ...
            (
                "Garcia General Trading",
                "Roberto Cruz Garcia",
                "Purok 1, 78 Bonifacio St.",
                "General Merchandise",
                750000.00,
                1200.00,
                "OR-2026-002",
            ...
            (
                "Mendoza Lechon Manok",
                "Corazon Torres Mendoza",
                "Purok 4, 56 Quezon St.",
                "Food - Lechon Manok",
                180000.00,
                350.00,
                "OR-2026-003",
            ...
            (
                "Castillo Transport Services",
                "Rodrigo Diaz Castillo",
                "Purok 2, 67 Legaspi Rd.",
                "Transport - Tricycle for Hire",
                120000.00,
                250.00,
                "OR-2026-004",
                "pending",
            ...
            (
                ...
                "Josefina Castro Navarro",
                "Purok 4, 28 Quezon Ave.",
        ...
        for row in businesses:
            ...
            action = "Created" if created else "Already exists"
            self.stdout.write(
                f"  [{action}] {permit.business_name} ({permit.permit_number})"
            )

        self.stdout.write(
            self.style.SUCCESS(f"  → {len(businesses)} business permits processed.\n")
        )
    ...
    def _seed_blotter_cases(self, residents):
        ...
        for case_data in cases_data:
            ...
            self.stdout.write(
                f"  [Created] {case.case_number} — {case.get_incident_type_display()} ({case.get_status_display()})"
            )

        self.stdout.write(
            self.style.SUCCESS(f"  → {len(cases_data)} blotter cases processed.\n")
        )
