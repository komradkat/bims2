...
class EmergencyService(models.Model):
    ...
    description = models.TextField(blank=True, help_text="Optional details about this location")
    address = models.TextField(blank=True)
    contact_number = models.CharField(max_length=50, blank=True)
    icon_emoji = models.CharField(max_length=10, blank=True, help_text="Custom emoji for 'other' types")
