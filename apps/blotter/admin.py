...
class BlotterCaseAdmin(admin.ModelAdmin):
    list_display = ['case_number', 'incident_type', 'incident_date', 'status', 'created_at']
    list_filter = ['status', 'incident_type', 'incident_date']
    search_fields = ['case_number', 'narrative', 'complainants__name', 'respondents__name', 'complainants__resident__last_name', 'respondents__resident__last_name']
