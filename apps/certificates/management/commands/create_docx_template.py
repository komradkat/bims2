...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        run = purpose.add_run('    This certification is being issued upon the request of the above-mentioned person for ')
        run.font.name = 'Times New Roman'
        run.font.size = Pt(12)
        ...
        run = date_p.add_run('Issued this {{ day }} day of {{ month_year }} at the Office of the Punong Barangay.')
        run.font.name = 'Times New Roman'
        run.font.size = Pt(12)
        run.font.italic = True
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully created starter template: {filepath}'))
